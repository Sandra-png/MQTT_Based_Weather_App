...
from mqtt_config.mqtt_config import broker_address, broker_port, topic, generate_client_id
import sqlite3
import json
import traceback
...
# -- DATABASE SETUP --
try:
    conn = sqlite3.connect ("/app/data/weather.db", check_same_thread=False)
    cursor = conn.cursor()
    cursor.execute ("""
