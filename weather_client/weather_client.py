...
from mqtt_config.mqtt_config import broker_address, broker_port, topic, publish_interval, generate_client_id
import json
import random
import time
import traceback
...
try:
    ...
    time.sleep (5) # Delay to let subscriber connect first
    ...
    while True:
        ...
        condition = random.choice (["Sunny", "Raining", "Snowing", "Clouded"])
